...
import QualityInfo from "../forms/QualityInfo";
import VideoInfo from "../forms/VideoInfo";
...
const CreateEpisodes = () => {
  ...
  return (
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="col-span-1 gap-6">
              <div className="flex flex-col gap-2 w-full">
                ...
                <div className="w-full h-56 border-2 border-dashed border-gray-400 flex items-center justify-center cursor-pointer rounded-lg bg-gray-50 hover:bg-gray-100">
    ...
    `,
                      setup: (editor) => {
                        editor.on("init", () => {
                          editor.getBody().style.overflow = "auto"; // Enable scrolling
                        });
                      },
                    }}
